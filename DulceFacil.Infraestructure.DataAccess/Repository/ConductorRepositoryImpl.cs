...
{
    public class ConductorRepositoryImpl : RepositoryImpl<Conductor>, IConductorRepository
    {
        public ConductorRepositoryImpl(DulceFacilContext context) : base(context)
        {
        }
    }
}
